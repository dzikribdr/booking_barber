...
class ShaveServicesPage extends StatelessWidget {
  const ShaveServicesPage({super.key});

  @override
  Widget build(BuildContext context) {
    final serviceProvider = context.watch<ServiceProvider?>();
    final services = serviceProvider?.services.where((s) => s.category == 'Shave').toList() ?? [];
...
class _ShaveServiceCard extends StatelessWidget {
  final ServiceItem service;

  const _ShaveServiceCard({
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: service.imageUrl == null ? const Center(child: Icon(Icons.water_drop_outlined, size: 60, color: Colors.white12)) : null,
          ),
          Padding(
            padding: const EdgeInsets.all(24.0),
            child: Column(
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Book Service', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ],
